...
import {
    MoreVertical, Pencil, KeyRound, Trash2
} from "lucide-react";
import "../styles/InventarioPage.css";

export default function UsuariosActions({
    usuario, onEditar, onPassword, onEliminar
}) {
      ...
      {abierto && (
        <div className="acciones-menu-dropdown">
          ...
          <button
            ...
            className="acciones-menu-item"
            onClick={() =>
              ejecutarAccion(() => onPassword(usuario.idUsuario))
            }
          >
            <KeyRound size={16} />
            Cambiar contraseña
          ...
          <button
            ...
            onClick={() =>
              ejecutarAccion(() => onEliminar(usuario.idUsuario))
            }
          >
