          ...
          <div className="modal-overlay">
            <div className="modal modal-responsiva">
              ...
              <div className="responsiva-steps">
                ...
                <div
                  className={`responsiva-step ${pasoResponsiva >= 1 ? "activo" : ""
                    }`}
                >
                  <span>1</span>
